...
function Faq() {
  return (
    <article
      id="faqs"
      className="min-h-[calc('100vh - 56px')] mt-0 flex w-full items-center justify-center bg-[url('asset/faq.png')] bg-cover bg-center bg-no-repeat px-6 py-20 md:scroll-mt-6 md:bg-auto md:bg-position-[initial]"
    >
