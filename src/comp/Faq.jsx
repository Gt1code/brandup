...
function Faq() {
  return (
    <article
      id="faqs"
      className="min-h-[calc('100vh - 56px')] mt-0 flex w-full items-center justify-center bg-[#ABB7B3]/30 px-6 py-20 bg-blend-multiply md:scroll-mt-6 md:bg-auto md:bg-position-[initial]"
    >
